...
CREATE DATABASE IF NOT EXISTS ComercioEletronico;
...
-- View para mostrar o histórico de pedidos de um cliente
...
-- View para listar todos os produtos disponíveis (não esgotados)
CREATE VIEW ProdutosDisponiveis AS
SELECT *
FROM Produtos
WHERE QuantidadeEstoque > 0;

-- Inserção de dados nas tabelas (exemplo com 20 dados em cada tabela)
-- Inserção de 20 dados fictícios na tabela Produtos
...
-- Inserção de 20 dados fictícios na tabela Clientes
...
-- Inserção de 20 dados fictícios na tabela Pedidos
...
-- Inserção de 20 dados fictícios na tabela Itens_Pedido
INSERT INTO Itens_Pedido (Id_Pedido, id_Produto, Quantidade)
VALUES
    (1, 1, 2),
    (1, 2, 1),
